...
namespace Oxide.Plugins
{
    ...
    {
        [PluginReference] private Plugin ServerRewards, Economics, ImageLibrary, WelcomeController, NoEscape, ApAuction;
        ...
        private void CMDSocMain(ConsoleSystem.Arg arg)
        {
            ...
            switch (arg.Args[0].ToString())
            {
                case "close":
                    ...
                    break;
                case "itempage":
                    playerSettings.ItemPage = int.Parse(arg.Args[1].ToString());
                ...
                case "itemfilter":
                    ...
                    break;
                case "buyitem":
                    var theItem = _itemList.SelectMany(x => x.Value).Where(x => x.SpecialId == int.Parse(arg.Args[1].ToString())).Select(x => new ItemOption(x)).FirstOrDefault();
                    ...
                    break;
                case "category":
                    playerSettings.Category = arg.Args[1].ToString();
                    UIGenerateShopItems(player, playerSettings);
                    UIGenerateShopCategories(player, playerSettings);
                    break;
                case "categorypage":
                    playerSettings.CategoryPage = int.Parse(arg.Args[1].ToString());
                    UIGenerateShopCategories(player, playerSettings);
                    break;
                case "additem":
                    var specialId = int.Parse(arg.Args[1].ToString());
                    var cost = int.Parse(arg.Args[2].ToString());
                    var itemId = int.Parse(arg.Args[3].ToString());
                ...
                case "commandpanel":
                    ...
                    break;
                case "commandspage":
                    playerSettings.CommandsPage = int.Parse(arg.Args[1].ToString());
                    UIGenerateShopCategories(player, playerSettings, true);
                    UIGenerateCommands(player, playerSettings);
                    break;
                case "buycommand":
                    var theCommand = _commandList.FirstOrDefault(x => x.CommandSpecialId == int.Parse(arg.Args[1].ToString()));
                    ...
                    break;
                case "sellback":
                    theItem = _itemList.SelectMany(x => x.Value).FirstOrDefault(x => x.SpecialId == int.Parse(arg.Args[1].ToString()));
        ...
        private void CMDSocCart(ConsoleSystem.Arg arg)
        {
            ...
            switch (arg.Args[0].ToString())
            {
                case "removeitem":
                    ...
                    break;
                case "deleteitem":
                    specialId = int.Parse(arg.Args[1].ToString());
                    playerSettings.CurrentCartItems.RemoveAll(x => x.SpecialId == specialId);
                    break;
                case "page":
                    playerSettings.CurrentCartPage = int.Parse(arg.Args[1].ToString());
                    break;
                case "save":
                    ...
                    break;
                case "savedpage":
                    playerSettings.CurrentSavedCartPage = int.Parse(arg.Args[1].ToString());
                    break;
                case "view":
                    playerSettings.CartView = arg.Args[1].ToString();
                    break;
                case "closeview":
            ...
            UIGenerateCart(player, playerSettings, arg.Args[0].ToString() == "view");
        }
        ...
        private void CMDSocEdit(ConsoleSystem.Arg arg)
        {
            ...
            switch (arg.Args[0].ToString())
            {
                ...
                case "open":
                    ...
                    break;
                case "category":
                    playerSettings.EditCategory = arg.Args[1].ToString();
                    ...
                    break;
                case "categorypage":
                    playerSettings.EditCategoryPage = int.Parse(arg.Args[1].ToString());
                    UIGenerateEditCategories(player, playerSettings);
                    break;
                case "item":
                    ...
                    playerSettings.ItemOption = neededItems.FirstOrDefault(x => x.ItemId == int.Parse(arg.Args[1].ToString()));
                    ...
                    break;
                case "itempage":
                    playerSettings.EditItemPage = int.Parse(arg.Args[1].ToString());
                    UIGenerateEditItems(player, playerSettings);
                    break;
                case "itemfilter":
                ...
                case "enabled":
                    ...
                    break;
                case "amount":
                    if (arg.Args.Length > 1 && !string.IsNullOrEmpty(arg.Args[1].ToString()))
                    {
                        if (int.TryParse(arg.Args[1].ToString(), out int amount))
                        {
                ...
                case "cooldown":
                    if (arg.Args.Length > 1 && !string.IsNullOrEmpty(arg.Args[1].ToString()))
                    {
                        if (double.TryParse(arg.Args[1].ToString(), out double amount))
                        {
                ...
                case "skinid":
                    if (arg.Args.Length > 1 && !string.IsNullOrEmpty(arg.Args[1].ToString()))
                    {
                        if (ulong.TryParse(arg.Args[1].ToString(), out ulong skinid))
                        {
                ...
                case "cost":
                    if (arg.Args.Length > 1 && !string.IsNullOrEmpty(arg.Args[1].ToString()))
                    {
                        if (int.TryParse(arg.Args[1].ToString(), out int cost))
                        {
        ...
        private void CMDSocEditCommand(ConsoleSystem.Arg arg)
        {
            ...
            switch (arg.Args[0].ToString())
            {
                case "close":
                    ...
                    break;
                case "selectcommand":
                    var foundCommand = _commandList.FirstOrDefault(x => x.CommandSpecialId == int.Parse(arg.Args[1].ToString())).Clone();
                ...
                case "altercommand":
                    ...
                    var index = int.Parse(arg.Args[1].ToString());

                    if (string.IsNullOrEmpty(arg.Args[2].ToString())) playerSettings.CommandOption.Commands.RemoveAt(index);
                ...
                case "addnewcommand":
                    ...
                    break;
                case "deletecommand":
                    playerSettings.CommandOption.Commands.RemoveAt(int.Parse(arg.Args[1].ToString()));
                    UIGenerateCommandEdit(player, playerSettings);
                    break;
                case "deletesavedcommand":
                    ...
                    break;
                case "page":
                    playerSettings.CommandsEditPage = int.Parse(arg.Args[1].ToString());
                    UIGenerateCommandEdit(player, playerSettings);
                    break;
                case "commandpage":
                    playerSettings.CommandsEditSelectPage = int.Parse(arg.Args[1].ToString());
                    UIGenerateEditCommands(player, playerSettings);
                    break;
                case "displayname":
                ...
                case "image":
                    ...
                    {
                        playerSettings.CommandOption.CommandImage = arg.Args[1].ToString();
                        RegisterNewImage($"EditCommand{playerSettings.CommandOption.CommandName}", arg.Args[1].ToString());
        ...
        private void UIGenerateTopBar(BasePlayer player, PlayerSettings playerSettings, bool isEditPage = false)
        {
            ...
            // Player market button (opens the ApAuction market UI)
            if (!isEditPage && ApAuction != null)
                CreateButton(ref container, ".74 .08", ".885 .87", _uiColors.ThingBackgroundColor, "1 1 1 1", "MARKET", 20, "soc_market", "SOCShopTopPanelOverlay");

            CuiHelper.DestroyUi(player, "SOCShopTopPanelOverlay");
            CuiHelper.AddUi(player, container);
        }

        [ConsoleCommand("soc_market")]
        private void CMDSocMarket(ConsoleSystem.Arg arg)
        {
            var player = arg.Player();
            if (player == null) return;
            // Close the shop UI, then open the player market.
            CuiHelper.DestroyUi(player, "SOCMainPanel");
            if (usingWC) CuiHelper.DestroyUi(player, "BackgrounPanel");
            if (ApAuction != null) ApAuction.Call("OpenMarketUi", player);
            else player.ChatMessage("The market is currently unavailable.");
        }
